...
def visualize_networks(input_folder, input_sfolder, edges_df, xpaths, file_nodes, columns_nodes, output_folder, book,  mode, columns_edges = ["Source","Target",'Weight','Type'], language = "sp", entities_type = ["person","group"], dpi = 300):
    ...
    plt.axis('off')
    pos = nx.spring_layout(graph, k=4, iterations=300)
...
def create_networks_bible( mode = "directed", xpaths = {"q" : ["@who", "@toWhom", "@type"]},
                          books_bible = ['HEB','RUT','1SA', '2SA','GEN','EXO','PSA','JON','MIC','NAH','HAB','ZEP','HAG','ZEC','MAL','MAT','JOH','ACT','REV','1JO','2JO','3JO','JUD', "JOB", "JAM", "1PE", "2PE", "EZE", "ECC","ROM","1CO","2CO","JOS","MAR","LUK","DAN","HOS","JDG","OBA","JOE","PHM","NEH","EZR","1TI", "2TI", "TIT","JER","PHI","AMO","LEV","LAM","GAL","1KI","1TH","2TH","ISA","EPH","2KI","EST","NUM","PRO","COL","DEU","Bible", ],
...
#create_networks_bible(mode = "directed", xpaths = {"q" : ["@who", "@toWhom","@type"]}, books_bible = ['DEU'])

#create_networks_bible(mode = "undirected", xpaths = {"q" : ["@who", "@toWhom"], "rs" : ["@key"]} , books_bible = ['DEU'])
