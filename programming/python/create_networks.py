...
def create_networks_bible( mode = "directed", xpaths = {"q" : ["@who", "@toWhom", "@type"]},
                          books_bible = ['HEB','RUT','1SA', '2SA','GEN','EXO','PSA','JON','MIC','NAH','HAB','ZEP','HAG','ZEC','MAL','MAT','JOH','ACT','REV','1JO','2JO','3JO','JUD', "JOB", "JAM", "1PE", "2PE", "EZE", "ECC","ROM","1CO","2CO","JOS","MAR","LUK","DAN","HOS","JDG","OBA","JOE","PHM","NEH","EZR","1TI", "2TI", "TIT","JER","PHI","AMO","LEV","LAM","GAL","1KI","1TH","2TH","ISA","EPH","2KI","EST","NUM","PRO","COL","DEU","SON","1CH","2CH","Bible", ],
