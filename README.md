...
This project encodes the Bible in TEI, starting with the John and Mathew Gospels, Apocalypse, Genesis, Ruth, Jonah, 75 Psalms and Acts in Spanish. José Calvo Tello started this project because the Bible is a interesting text that speaks to everyone, and XML-TEI makes possible to listen the text in new ways. 
